...
 
Próximas Etapas
5.	Inventário técnico da V1.
6.	Comparação V1 × especificação V2.
7.	Definição da arquitetura V2.
8.	Modelagem de banco de dados.
9.	Definição de RLS e matriz técnica de permissões.
10.	Definição dos componentes compartilhados e bibliotecas.
11.	Plano de implementação por fases.
12.	Implementação e testes.
